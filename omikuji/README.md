...
このプロジェクトでは PokéAPI（https://pokeapi.co/）を利用しています。

PokéAPI ライセンス

Copyright (c) 2013–2023 Paul Hallett および PokéAPI コントリビューター
https://github.com/PokeAPI/pokeapi

ポケモンのデータおよびアセットについて

ポケモンおよびポケモンのキャラクター名は、任天堂の商標です。
© 2024 Pokémon. © 1995–2024 Nintendo / Creatures Inc. / GAME FREAK inc.

本プロジェクトは 個人の学習目的で作成されたものであり、
任天堂、株式会社ポケモン、またはゲームフリークとは
提携・承認・後援・公式な関係は一切ありません。
